...
<body class="nav-md">
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            ...
            <a href="{{url($home_page_url_boot->url)}}" class="site_title"><i class="fa fa-paw"></i> <span>dartsinabottle</span></a>
          </div>
          ...
          <div class="profile">
            ...
            <div class="profile_info">
              <span>Welcome,</span>
              {{-- <h2>{{$user_boot->first_name." ".$user_boot->last_name}}</h2> --}}
            </div>
          </div>
          <!-- /menu prile quick info -->
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-bar-chart-o"></i> Orders <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                   ...
                   <!--  <li><a href="{{url('orders/pending-design')}}">Pending Design</a>
                    </li> -->
                    <li><a href="{{url('orders/pending-shipment')}}">Pending Shipment</a>
                    </li>
                    <li><a href="{{url('orders/shipped')}}">Shipped</a>
                    </li>
                    
                  </ul>
                </li>

                {{-- <li><a href="{{url('order-assets')}}"><i class="fa fa-edit"></i> Order Assets</a>
  ...
  {{-- <script src="{{asset('assets/customer/js/customer-panel.js')}}"></script> --}}
