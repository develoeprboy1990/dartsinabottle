...
<p style="text-align:left;">We refer to the barrels that you may lend as LENT darts and the barrels you receive from other users as; -
<ul>
    <li>CURRENT darts (the barrels currently in your possession that we have sent you from other users LENT darts and our own stock); and </li>
    <li>BORROWED darts (the barrels you have previously received and returned to us)</li>
</ul>
LENT darts must be tungsten alloy barrels. We do not accept barrels of any other material or metal such as nickel silver or brass.</p>

<p style="text-align:left;">
    <b style="text-decoration: underline;">USE</b><br>
You shall use our website to connect with people who will send their own LENT darts in, and these darts will be shared with other users.<br>
WE DO NOT PROVIDE WHOLE SETS OF DARTS. WE ONLY PROVIDE THE BARRELS. YOU WILL NOT RECEIVE ANY FLIGHTS OR STEMS FROM THE US.</p> 
...
Upon registration, you will choose your subscription plan. The cheapest plan is £15.99 a month (to borrow two sets a month, a 30-day period), and the most expensive one is £24.99 to borrow four sets a month.<br>
The payments shall be made via Paypal or Stripe.<br>
You will also need to pay a one-off payment of £40 or £50, which will be kept as your deposit.<br>
...
To use dartsinabottle, you must have three functioning IDENTICAL (identical, meaning the same brand, model, and weight) tungsten alloy barrels to lend and provide us with a Payment Method.<br>
...
After choosing to cancel, you must return any outstanding CURRENT darts in your possession. When we have received those darts and they have been checked to be in a working condition, we will process the return of any outstanding deposit, and return any LENT darts to you after they are returned to us by whoever has them.<br>
WE ARE NOT RESPONSIBLE FOR DELAYS IN LENT DARTS BEING RETURNED.<br>
...
YOU ACKNOWLEDGE THAT THE BARRELS ARE PROVIDED “AS IS,” AND WE MAKE NO GUARANTEES OR WARRANTIES THAT THEY WILL ALWAYS FUNCTION WITHOUT IMPERFECTIONS OR DAMAGE, WHICH MAY RENDER THEM UNUSABLE. <br>
...
Upon subscribing to dartsinabottle via the ‘deposit+lend’ method, we will send you an envelope containing a prepaid self-addressed envelope and a plastic bottle with a cork top. You will place your tungsten LENT barrels in the cork top (so the barrels are contained in the bottle) and send the bottle back to us via the self-addressed envelope.  <br>  
When we have received your LENT darts, you may choose your 1st set of CURRENT darts. These will be posted in a bottle inside an envelope containing another prepaid self-addressed envelope. <br>
...
ALL POSTAGE WILL BE DONE VIA ROYAL MAIL 1st CLASS. CURRENT DARTS SENT TO YOU WILL BE SENT VIA 1st CLASS SIGNED FOR. THE PREPAID ENVELOPES THAT YOU RETURN YOUR CURRENT DARTS IN WILL BE STANDARD 1ST CLASS. PLEASE ALLOW UP TO 3 WORKING DAYS FOR DELIVERY. <br>
...
<ul>
    ...
    <li>From the time you are sending back CURRENT darts to receiving new CURRENT DARTS – 3-5 working days</li>
</ul>
If you join using the ‘deposit only’ method, we will not send you an empty bottle. You may choose your first set of CURRENT darts immediately and postage will be done as above. <br>
...
IN THE EVENT YOU SEND YOUR CURRENT DARTS BACK, BUT WE HAVE NOT RECEIVED THEM, AND YOU HAVE NO PROOF OF POSTAGE, WE ARE AUTHORIZED TO USE YOUR DEPOSIT TO COMPENSATE OURSELEVES OR THE OTHER USER TO WHOM THE LENT DARTS BELONG TO. WE MAY ALSO SUSPEND/CANCEL YOUR MEMBERSHIP.<br>
IN THE EVENT THE ABOVE HAPPENS AND YOU AGAIN STATE THAT CURRENT DARTS HAVE BEEN RETURNED, WITHOUT PROOF OF POSTAGE, WE ARE AUTHORISED TO KEEP ANY OF YOUR LENT BARRELS AND SUSPEND/CANCEL YOUR MEMBERSHIP. This is to keep dartsinabottle a safe and honest way of sharing barrels.<br>
In the event you send back 1 or 2 barrels of your current darts instead of 3 we are authorised to use your deposit to compensate the user who sent said darts. <br> 
...
In the event you send back CURRENT DARTS where one or more points has been broken, we are authorised to use your deposit to replace the point(s). You will be notified through email of the costs and your newly updated deposit amount.  <br>
</p>
<p style="text-align:left;">
    <b style="text-decoration: underline;">PURCHASE (selling/buying)</b><br>
By default, your LENT darts are set ‘NOT FOR SALE.’<br>
You can choose a price you wish to sell your LENT darts for by selecting a price on the ‘Lent Darts’ page. <br>
You agree that any user currently in possession of your LENT darts may buy them via PayPal. <br>
