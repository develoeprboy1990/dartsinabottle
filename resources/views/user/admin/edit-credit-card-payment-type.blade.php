                ...
                <div class="x_content">
                  ...
                  {{ Form::open(['url' => 'admin/payment-types/'.$payment_type->id, 'method' => 'put', 'class' => 'form-horizontal form-label-left', 'id' => 'edit_payment_type_form']) }}
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Login ID<span class="required">*</span>
                      </label>
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Transaction Key<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="x_content">  
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                               ...
                               {{ Form::open(['url' => 'admin/payment-types/'.$payment_type->id, 'method' => 'put', 'class' => 'form-horizontal form-label-left', 'id' => 'edit_payment_type_form']) }} 
                                ...
                                <div class="form-group">
                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="api-key">Login ID <span class="required">*</span>
                                  </label>
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="secret-key">Transaction Key<span class="required">*</span>
                                  </label>
                                  <div class="col-md-6 col-sm-6 col-xs-12">
