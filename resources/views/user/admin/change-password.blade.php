        ...
        <div class="">
          ...
          <div class="page-title">
            <div class="title_left">
              <h3>Change Your Existing Passsword</h3>
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form id="change_password_form" method="post" action="{{url('admin/change-password')}}"  data-parsley-validate class="form-horizontal form-label-left">
                    {{csrf_field()}}
