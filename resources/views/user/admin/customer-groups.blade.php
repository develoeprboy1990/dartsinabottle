                    ...
                    <div class="x_panel">
                      <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                          <a href="{{url('admin/customer-groups/create')}}" class="btn btn-primary">Add Customer Group</a>
                         ...
                         @foreach($customer_groups as $result)
                            <tr>
                              ...
                              <td>
                                ...
                                <a href="{{ url('admin/customer-groups/'.$result->id.'/edit') }}" title="Edit"><i class="fa fa-pencil"></i></a>
                              
                             {{--    {{Form::open(array('url'=>'admin/customer-groups/'.$result->id,'method'=>'DELETE','id'=>'del_product_form'.$result->id )) }}
