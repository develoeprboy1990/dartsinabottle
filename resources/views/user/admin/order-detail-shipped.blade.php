...
<div class="right_col" role="main">
  ...
  <div class="page-title">
    <div class="title_left">
      <h3>Subscription Detail / Shipped</h3>
    </div>
    <div class="title_right">
      <div class="pull-right top_search">
        <div class="input-group">
          ...
          @endif  
          @if($order_detail->status == 1 && $order_detail->isunsubscribe ==1)
  ...
  <div class="clearfix"></div>
   <div class="alert alert-info alert-dismissible">
    ...
    <strong class="blink">Note! Order is Cancel from Customer.</strong> 
  </div>
  @endif
              ...
              <div class="panel panel-primary">
                ...
                <div class="panel-body">
                 ...
                 <tbody>
                   ...
                   <tr>
                      <th>Town/City</th>
                      <td>{{@$order_detail->getBillingDetail->getCity->name}}</td>  
                   </tr> 
