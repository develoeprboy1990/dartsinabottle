              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  {{ Form::open(['url' => 'admin/payment-types/'.$payment_type->id, 'method' => 'put', 'class' => 'form-horizontal form-label-left', 'id' => 'edit_payment_type_form']) }}
                    {{csrf_field()}}
                    <input type="hidden" name="payment_account_type" value="developer" >
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Publishable key<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="api_key"  name="api_key" required="required" class="form-control col-md-7 col-xs-12" value={{$payment_type->api_key}}>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Secret key<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="secret_key"  name="secret_key" required="required" class="form-control col-md-7 col-xs-12" value={{$payment_type->secret_key}}>
                      </div>
                    </div>
                    ...
                    <div class="x_content">  
                        <div class="col-md-12 col-sm-12 col-xs-12">                           
                               {{ Form::open(['url' => 'admin/payment-types/'.$payment_type->id, 'method' => 'put', 'class' => 'form-horizontal form-label-left', 'id' => 'edit_payment_type_form']) }} 
                                ...
                                <div class="form-group">
                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="api-key">Publishable key <span class="required">*</span>
                                  </label>
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="secret-key">Secret key<span class="required">*</span>
                                  </label>
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12">
                              ...
                              <br />
                               ...
                               <form  method="post" action="{{url('admin/choose-account-type-process')}}" data-parsley-validate class="form-label-left">
                                ...
                                @php
                                if($payment_type->active_account == "developer")
                                {
                                  $developer_checked="checked";
                                } 
                                elseif ($payment_type->active_account == "test") 
                                {
                                ...
                                <div class="radio">
                                  <label><input type="radio" name="active_account" value="developer" {{@$developer_checked}}>Developer</label>
                                </div>
                                <div class="radio">
